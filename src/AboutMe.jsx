export default function AboutMe() {
  return (
    <div className="h-full flex-1 p-8 bg-[#23293a] text-white flex flex-col items-center justify-center">
      <h1 className="text-3xl font-bold text-blue-200 mb-4">About Me</h1>
      ...
      <p className="text-md text-gray-400 mb-4 max-w-2xl text-center">
      ...
      <p className="text-md text-gray-400 mb-8 max-w-2xl text-center">
